...
Además con apoyo de RQt, se puede visualizar el valor actual de algunos tópicos, en este caso se eligió el estado de la batería como se muestra en la Figura \ref{RQt mostrando los datos del tópico battery.}.
